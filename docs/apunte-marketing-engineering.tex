...
Aplicando esta definición, se puede demostrar que la probabilidad de elección en un modelo logit corresponde a una fórmula cerrada sencilla (para el detalle de la derivación ver \hyperref[apuxe9ndice]{apéndice}):
...
\chapter*{Anexo Didáctico: Recomendaciones para Regresión}\label{anexo-diduxe1ctico-recomendaciones-para-regresiuxf3n}
\addcontentsline{toc}{chapter}{Anexo Didáctico: Recomendaciones para Regresión}
