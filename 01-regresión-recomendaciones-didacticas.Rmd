...
## Nota de trabajo didáctico {-}

Este archivo es una copia de trabajo de `01-regresión.Rmd` pensada para
...
`ApunteEjercicios/02-regresion.Rmd`.

## Mapa de mejoras didácticas sugeridas {-}

Se recomienda reorganizar el capítulo con una lógica de libro
educativo:

1. Apertura de unidad: para qué sirve la regresión en marketing,
   habilidades previas, errores esperables y ruta de lectura.
2. Definiciones clave: una sola sección breve y visible antes de entrar
   a notación y OLS.
3. Ejemplos mínimos resueltos: uno conceptual, uno de interpretación y
   uno de evaluación de modelos.
4. Práctica guiada corta: usar los ejercicios teóricos iniciales del
   apunte de ejercicios como puente antes de los problemas grandes.
5. Sumario único de unidad: reunir en un solo lugar conceptos,
   decisiones de modelamiento, métricas y advertencias de
   interpretación.

# Anexo Didáctico: Recomendaciones para Regresión {-}

## Conceptos básicos de regresión

> **Recomendación didáctica 1: Apertura de unidad**
>
> Antes del primer párrafo conviene agregar un bloque corto con cuatro
> piezas: `para qué sirve esta unidad`, `habilidades requeridas`,
> `qué debería poder hacer el estudiante al terminar` y `cómo se conecta
> con el apunte de ejercicios`.
>
...
> pregunta `E7: ¿Qué es un modelo de regresión?` de
> `ApunteEjercicios/02-regresion.Rmd`.
...
> **Recomendación didáctica 2: Apartado de definiciones**
>
> Justo antes de `Notación` conviene insertar un recuadro titulado
> `Definiciones clave` con 6 a 8 términos de uso recurrente:
...
> **Recomendación didáctica 3: Primer ejemplo completamente resuelto**
>
> Después de `Propiedades` conviene agregar un ejemplo pequeño, con muy
> pocos datos, que muestre la diferencia entre `especificar un modelo`,
> `estimar coeficientes` e `interpretar un resultado`.
>
...
> **Recomendación didáctica 4: Checklist de construcción**
>
> Esta sección ya tiene mucho valor formativo. Se puede volver todavía
> más enseñable si se transforma explícitamente en un `checklist de
> modelamiento` con pasos numerados y una pregunta guía por paso.
>
...
> **Recomendación didáctica 5: Práctica guiada de transformaciones**
>
> Aquí conviene insertar una microsección `Práctica guiada` con dos o
> tres miniitems de interpretación inmediata.
>
> Este es el mejor lugar para conectar con `E4: Regresión Log-Nivel y
> Log-Log` y con `E5: Capturar efectos` de
> `ApunteEjercicios/02-regresion.Rmd`, porque ambos funcionan como
...
> **Recomendación didáctica 6: Contraste manual vs automático**
>
> Al final de esta subsección conviene agregar una tabla breve con tres
> columnas: `criterio`, `ventaja`, `riesgo`.
>
> Aquí calza muy bien usar `E3: Selección automática de variables` como
...
> **Recomendación didáctica 7: Puente hacia especificaciones más ricas**
>
...
>
> El mejor puente aquí es `E6: Coeficientes y Parámetros`.
...
> **Recomendación didáctica 8: Unificar la evaluación en una sola pieza**
>
> En vez de dispersar demasiadas ideas de evaluación a lo largo del
> capítulo, conviene preparar aquí un `sumario de evaluación de modelos`
> en formato cuadro.
>
> Ese sumario único debería reunir: `qué quiere medir la métrica`,
> `cuándo usarla`, `qué riesgo tiene si se usa sola` y `qué tipo de
> decisión ayuda a tomar`.
...
```{r my-fig1-did, fig.cap="Error de calibración vs predicción",out.width='50%', fig.align='center'}
...
```{r my-fig2-did, fig.cap="Ejemplo de validación cruzada",out.width='70%', fig.align='center'}
knitr::include_graphics(rep("images/cv.png"))
```

### Test de hipótesis

> **Recomendación didáctica 9: Error frecuente de lectura**
>
> Después de esta sección sería muy útil incluir un recuadro corto de
> `Errores comunes`, por ejemplo:
> `significativo no implica importante`,
> `mejor ajuste no implica mejor pronóstico`,
> `mejor pronóstico no implica interpretación causal`.
>
> Ese recuadro ayudaría mucho a reducir errores de lectura en `E1:
> Signo esperado y significancia`.
...
> **Recomendación didáctica 10: Detenerse en causalidad vs correlación**
>
...
```{r my-fig3-did, fig.cap="Modelo de mediación",out.width='70%', fig.align='center'}
...
> **Recomendación didáctica 11: Señal de transición**
>
> Aquí conviene agregar un bloque muy visible que diga algo como
> `Cuándo la regresión lineal deja de ser suficiente`.
>
> La conexión natural con el apunte de ejercicios es
> `E2: Regresión Lineal vs de Poisson`, que sirve como chequeo rápido
...
> **Recomendación didáctica 12: Cierre de la unidad**
>
> Antes de entrar a esta sección, o bien al terminarla, conviene ubicar
> el `sumario único de la unidad`.
>
> Mi recomendación es que ese sumario cierre la parte principal del
> capítulo y contenga solo una página o dos como máximo:
> `ideas fuerza`, `definiciones`, `decisiones de modelamiento`,
> `métricas`, `errores comunes` y `preguntas que el estudiante debería
> poder responder`.
...
```{r mars-did, fig.cap="Regresión MARS para distinto número de bisagras",out.width='70%', fig.align='center'}
...
```{r knn-did, fig.cap="Regresión KNN para distinto número de vecinos cercanos",out.width='100%', fig.align='center'}
```
...
```{r ej1-did, fig.cap="Región de ejemplo", out.width='40%', fig.align='center'}
...
```{r ej2-did, fig.cap="Árbol de ejemplo",out.width='20%', fig.align='center'}
